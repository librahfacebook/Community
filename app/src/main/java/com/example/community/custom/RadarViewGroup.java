...
public class RadarViewGroup extends ViewGroup implements RadarView.IScanningListener{
    ...
    private SparseArray<PersonInfo> mDatas;//数据源
     ...
     * @param mDatas
     */
    public void setDatas(SparseArray<PersonInfo> mDatas) {
        this.mDatas = mDatas;
    ...
    private void startAnim(CircleView object, int position) {
        if (object != null) {
            object.setPortraitIcon(mDatas.get(position).getImage());
